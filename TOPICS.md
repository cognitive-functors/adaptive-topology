...
Flat keyword and topic index for search engines and AI agents.
...
group-theory, Z3-cubed, finite-group, abelian-group, cyclic-group,
...
resource-semantics, temporal-logic, LTL, CTL,
causal-networks, directed-graphs, energy-landscape, attractors,
information-entropy, network-diffusion, morphogenetic-fields,
...
Sleight-of-Mouth, perceptual-positions, Time-Line-Therapy, reframing,
negotiation, mediation, communication-analysis, conflict-resolution,
personality-typology, psychometrics, self-assessment,
...
- **Neuro-Linguistic Programming (NLP):** Metaprograms, neurological levels, Sleight of Mouth as C4 coordinates and transformations
- **TRIZ (Theory of Inventive Problem Solving):** Inventive principles mapped to C4 state transitions
- **Systems Thinking:** Senge's archetypes, Meadows' leverage points in C4 framework
- **Category Theory:** Heuristic categorical framing (functors, monoidal structure); explicitly acknowledged as motivational, not rigorous
...
- **Temporal Logic:** LTL/CTL for reasoning about cognitive trajectories
...
- **Bateson's Levels of Learning:** Mapped to D-axis (Scale) progression
- **Wilber's Integral Theory:** Four quadrants mapped to A-axis and D-axis combinations
- **Halliday's Systemic Functional Linguistics:** Ideational metafunction levels correspond to D-axis
- **Quantum Mechanics:** Entanglement as metaphor for correlated cognitive states (analogy, not formal)
- **Epigenetics:** Regulatory patterns as analogy for meta-cognitive state influence
- **Energy Landscapes:** Cognitive states as attractors in a potential landscape
- **Network Science:** Diffusion and connectivity on the 27-state graph
...
- **Ecology:** Niche partitioning as environmental fingerprint-based strategy routing

## Connections: C4 <-> MASTm

- **Fingerprint <-> Coordinates:** cv_nn_dist maps to heterogeneity, spectral_gap to decomposability, modularity to clustering; (T,D,A) maps to time/scale/agency axes -- same abstract protocol
...
Python, Agda, DeBERTa-v3-base, FastAPI, Docker, HTML/JavaScript (3D visualization),
Numba (JIT compilation), NumPy, SciPy, tsplib95
