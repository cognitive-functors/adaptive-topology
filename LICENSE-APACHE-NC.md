...
In addition to the terms and conditions of the Apache License 2.0, the following
restriction applies to all use of the Licensed Work:

**The Licensed Work may not be used for Commercial Purposes.**

### 1. Definition of Commercial Purposes

"Commercial Purposes" means any use intended for or directed toward commercial
advantage or monetary compensation. This includes, but is not limited to:

- Selling, licensing, or sublicensing the Licensed Work or derivative works
- Integrating the Licensed Work into a product or service offered for sale
- Using the Licensed Work to provide paid services (including SaaS)
...
- **Academic and scientific research** (including at universities, research
  institutes, and non-profit organizations)
- **Education and training** (including coursework, tutorials, and workshops)
- **Personal projects** that do not generate revenue
- **Evaluation and prototyping** for the purpose of assessing the Licensed Work
- **Open-source contributions** back to this project

### 3. Commercial Use Requires a Separate License

If you wish to use the Licensed Work for Commercial Purposes, you must obtain
a separate Commercial License. Contact the authors:
...
OUT OF OR IN CONNECTION WITH THE LICENSED WORK OR THE USE OR OTHER DEALINGS
