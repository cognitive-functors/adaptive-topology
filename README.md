...
| `code/python/` | demo + 3 examples | C4 classifier demo and examples |
...
**Total:** 17 unique research papers (12 bilingual EN+RU, 5 EN-only), 14 bilingual guides,
4 bilingual application docs, run-ready code with benchmark data.
...
- Empirical validation is preliminary (N~50, informal); large-scale studies are needed.
- Minimality of the 3-dimensional structure (Conjecture 2) remains unproven.
